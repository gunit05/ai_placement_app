...
class _InterviewScreenState extends State<InterviewScreen> {
  ...
  bool isMuted = false; // speaker
  bool micEnabled = true; // microphone
  ...
  Future<void> loadQuestions() async {
    try {
      ...
      if (userSkills.isEmpty) {
        userSkills = ["Flutter", "Java", "Python", "DSA", "Database"];
      }
...
Rules:
- First 5 must be TECHNICAL based on:
${userSkills.join(", ")}
...
""";
      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          "messages": [
            {
              "role": "system",
              "content": "You generate interview questions in JSON only."
            },
      ...
      if (response.statusCode == 200) {
        ...
        questions = List<String>.from(parsed);
      } else {
  ...
  Future<String?> uploadVideo(String filePath) async {
    try {
      final uri = Uri.parse(
        "https://api.cloudinary.com/v1_1/did6skwfo/video/upload",
      );
