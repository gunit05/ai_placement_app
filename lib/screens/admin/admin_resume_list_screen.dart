...
import 'package:hire_hub/screens/admin/admin_resume_score_screen.dart';
import 'package:hire_hub/screens/common/pdf_viewer_screen.dart';
          ...
          Expanded(
            child: loading
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      final r = filteredResumes[i];
                      final username = r['username'];
                      final scoreData = r['resume_scores'];
                      final manual = scoreData?['score'] ?? 0;
                      final ai = scoreData?['ai_score'] ?? 0;
                        ...
                        child: PremiumCard(
                          child: Column(
                            children: [
                              ...
                              Row(
                                children: [
                                  Expanded(child: chip("Manual", manual, Colors.orange)),
                                  const SizedBox(width: 10),
                                  Expanded(child: chip("AI", ai, Colors.green)),
                                ],
                              ),
                                    ...
                                    child: PremiumButton(
                                      ...
                                      onTap: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (_) => PdfViewerScreen(url: r['file_url']),
                                          ),
                                        );
                                      },
                                    ),
                                    ...
                                    child: PremiumButton(
                                      ...
                                      onTap: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (_) => AdminResumeScoreScreen(username: username),
                                          ),
                                        );
                                      },
                                    ),
